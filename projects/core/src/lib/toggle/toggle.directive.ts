...
@Directive({
  selector: 'button[tonToggle]',
  providers: [
    { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => TonToggleDirective), multi: true },
  ],
  host: {
    '[class]': 'computedClass()',
...
export class TonToggleDirective implements ControlValueAccessor {
