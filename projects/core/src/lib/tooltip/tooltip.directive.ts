...
export class TonTooltipDirective implements OnDestroy {
  readonly tonTooltip = input.required<string>();
  ...
  readonly tooltipId = `ton-tooltip-${++tooltipIdCounter}`;
  ...
  private createTooltip(): void {
    ...
    tooltip.textContent = this.tonTooltip();
