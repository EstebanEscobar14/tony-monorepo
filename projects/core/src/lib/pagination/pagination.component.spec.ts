...
import { TonPaginationComponent } from './pagination.component';

@Component({
  standalone: true,
  imports: [TonPaginationComponent],
  template: `<ton-pagination [(currentPage)]="currentPage" [totalPages]="totalPages()" />`,
})
...
describe('TonPaginationComponent', () => {
  ...
  beforeEach(async () => {
    ...
    host = fixture.nativeElement.querySelector('ton-pagination');
  });
