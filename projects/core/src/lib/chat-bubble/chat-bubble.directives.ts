...
export const SNY_CHAT_BUBBLE = new InjectionToken<TonChatBubbleDirective>('TonChatBubble');

@Directive({
  selector: '[tonChatBubble]',
  providers: [{ provide: SNY_CHAT_BUBBLE, useExisting: TonChatBubbleDirective }],
  host: {
    'role': 'article',
    '[class]': 'computedClass()',
  },
