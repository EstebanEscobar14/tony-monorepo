...
@Component({
  selector: 'ton-otp-input',
  changeDetection: ChangeDetectionStrategy.OnPush,
  providers: [
    { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => TonOtpInputComponent), multi: true },
  ],
  template: `
    <div
      role="group"
...
export class TonOtpInputComponent implements ControlValueAccessor {
  // Public API
