...
import { TonCommandPaletteService } from './command-palette.service';
...
class TestHostComponent {
  readonly service = inject(TonCommandPaletteService);
...
describe('TonCommandPaletteComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [TonDialogService, TonCommandPaletteService],
    }).compileComponents();
  ...
  function getPaletteEl(): HTMLElement | null {
    return document.querySelector('ton-command-palette');
  }
  ...
  it('should prevent double open', () => {
    ...
    host.open();
    fixture.detectChanges();
    const palettes = document.querySelectorAll('ton-command-palette');
