...
@Component({
  standalone: true,
  imports: [TonPopoverDirective, TonPopoverTriggerDirective, TonPopoverContentDirective],
  template: `
    <div tonPopover [matchWidth]="matchWidth()" [closeOnOutside]="closeOnOutside()" [closeOnEscape]="closeOnEscape()" #pop="tonPopover">
      <button tonPopoverTrigger>Open</button>
...
describe('TonPopoverDirective', () => {
  ...
  function getTrigger(): HTMLButtonElement {
    return el.querySelector('[tonpopovertrigger]') as HTMLButtonElement;
  }

  function getContent(): HTMLElement | null {
    return el.querySelector('[tonPopoverContent], [tonpopovercontent]');
  }
  ...
  it('should close on escape', () => {
    ...
    const host = el.querySelector('[tonPopover], [tonpopover]') as HTMLElement;
