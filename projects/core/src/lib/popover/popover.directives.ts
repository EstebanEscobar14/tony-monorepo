...
export const SNY_POPOVER = new InjectionToken<TonPopoverDirective>('TonPopover');

@Directive({
  selector: '[tonPopover]',
  exportAs: 'tonPopover',
  providers: [{ provide: SNY_POPOVER, useExisting: TonPopoverDirective }],
  host: {
...
export class TonPopoverDirective implements OnDestroy {
...
export class TonPopoverTriggerDirective {
...
export class TonPopoverContentDirective {
  protected readonly popover = inject(SNY_POPOVER);
  private readonly elRef = inject(ElementRef);
