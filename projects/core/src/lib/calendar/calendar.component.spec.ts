...
import { TonCalendarComponent } from './calendar.component';

@Component({
  standalone: true,
  imports: [TonCalendarComponent],
  template: `<ton-calendar [(value)]="selectedDate" />`,
})
class TestHostComponent {
  selectedDate = signal<Date | null>(null);
}

describe('TonCalendarComponent', () => {
  ...
  beforeEach(async () => {
    ...
    host = fixture.nativeElement.querySelector('ton-calendar');
  });
...
@Component({
  standalone: true,
  imports: [ReactiveFormsModule, TonCalendarComponent],
  template: `<ton-calendar [formControl]="ctrl" />`,
})
class ReactiveFormHost {
  ctrl = new FormControl<Date | null>(null);
}

describe('TonCalendarComponent — Reactive Forms', () => {
...
@Component({
  standalone: true,
  imports: [TonCalendarComponent],
  template: `<ton-calendar mode="range" [(rangeValue)]="range" />`,
})
class RangeTestHost {
  range = signal<DateRange | null>(null);
}

describe('TonCalendarComponent — Range Mode', () => {
