...
import { TonCalendarComponent } from '../calendar/calendar.component';
...
@Component({
  selector: 'ton-date-range-picker',
  ...
  providers: [
    { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => TonDateRangePickerComponent), multi: true },
  ],
  template: `
    <button
      #triggerEl
...
export class TonDateRangePickerComponent implements ControlValueAccessor, OnDestroy {
