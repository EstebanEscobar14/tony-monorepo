...
import { TonDividerComponent } from './divider.component';
import type { DividerOrientation } from './divider.variants';

@Component({
  standalone: true,
  imports: [TonDividerComponent],
  template: `<ton-divider [orientation]="orientation()" [label]="label()" />`,
})
...
describe('TonDividerComponent', () => {
  ...
  beforeEach(async () => {
    ...
    host = fixture.nativeElement.querySelector('ton-divider');
  });
