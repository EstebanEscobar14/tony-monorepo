...
@Component({
  selector: 'ton-file-input',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: {
    '[class]': '"w-full"',
  },
  providers: [
    { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => TonFileInputComponent), multi: true },
  ],
  template: `
    <label
      [class]="labelClass()"
...
export class TonFileInputComponent implements ControlValueAccessor {
