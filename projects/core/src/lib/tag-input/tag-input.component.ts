...
@Component({
  selector: 'ton-tag-input',
  changeDetection: ChangeDetectionStrategy.OnPush,
  providers: [
    { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => TonTagInputComponent), multi: true },
  ],
  template: `
...
export class TonTagInputComponent implements ControlValueAccessor {
