...
@Component({
  ...
  providers: [
    { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => TonComboboxComponent), multi: true },
  ],
  template: `
    <!-- Trigger button -->
    <button
...
export class TonComboboxComponent implements ControlValueAccessor, OnDestroy {
