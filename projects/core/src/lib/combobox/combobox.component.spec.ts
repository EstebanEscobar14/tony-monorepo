...
import { TonComboboxComponent, type ComboboxOption } from './combobox.component';

@Component({
  standalone: true,
  imports: [TonComboboxComponent],
  template: `<ton-combobox [options]="options" [(value)]="value" placeholder="Select..." searchPlaceholder="Search..." />`,
})
...
describe('TonComboboxComponent', () => {
  ...
  beforeEach(async () => {
    ...
    el = fixture.nativeElement.querySelector('ton-combobox');
...
@Component({
  standalone: true,
  imports: [ReactiveFormsModule, TonComboboxComponent],
  template: `<ton-combobox [options]="options" [formControl]="ctrl" placeholder="Select..." />`,
})
...
describe('TonComboboxComponent — Reactive Forms', () => {
