...
import { TonProgressComponent } from './progress.component';
import type { ProgressVariant, ProgressSize } from './progress.variants';

@Component({
  standalone: true,
  imports: [TonProgressComponent],
  template: `
    <ton-progress
      [value]="value()"
      [max]="max()"
...
describe('TonProgressComponent', () => {
  ...
  beforeEach(async () => {
    ...
    host = fixture.nativeElement.querySelector('ton-progress');
  });
