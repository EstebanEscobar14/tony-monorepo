...
@Component({
  standalone: true,
  imports: [TonTabsDirective, TonTabsListDirective, TonTabsTriggerDirective, TonTabsContentDirective],
  template: `
    <div tonTabs [(value)]="activeTab">
      <div tonTabsList>
        <button tonTabsTrigger value="tab1">Tab 1</button>
        <button tonTabsTrigger value="tab2">Tab 2</button>
      </div>
      <div tonTabsContent value="tab1">Content 1</div>
      <div tonTabsContent value="tab2">Content 2</div>
    </div>
  `,
})
...
@Component({
  ...
  imports: [TonTabsDirective, TonTabsListDirective, TonTabsTriggerDirective, TonTabsContentDirective],
  template: `
    <div tonTabs #t="tonTabs" [(value)]="activeTab">
      <div tonTabsList>
        <button tonTabsTrigger value="tab1">Tab 1</button>
      </div>
      <div tonTabsContent value="tab1">Content 1</div>
...
class ExportAsHost {
  activeTab = signal('tab1');
  tabs = viewChild<TonTabsDirective>('t');
}

describe('Tabs exportAs', () => {
  it('should expose tonTabs via template ref', async () => {
