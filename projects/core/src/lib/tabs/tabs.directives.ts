...
export const SNY_TABS = new InjectionToken<TonTabsDirective>('TonTabs');

@Directive({
  selector: '[tonTabs]',
  exportAs: 'tonTabs',
  providers: [{ provide: SNY_TABS, useExisting: TonTabsDirective }],
  host: { '[class]': 'computedClass()' },
})
export class TonTabsDirective {
...
export class TonTabsListDirective {
  readonly class = input<string>('');
...
export class TonTabsTriggerDirective {
...
export class TonTabsContentDirective {
  readonly value = input.required<string>();
  readonly class = input<string>('');
