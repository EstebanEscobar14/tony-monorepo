...
@Component({
  ...
  providers: [
    { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => TonColorPickerComponent), multi: true },
  ],
  template: `
    <!-- Trigger -->
    @if (!inline()) {
...
export class TonColorPickerComponent implements ControlValueAccessor, OnDestroy {
  // Public API
