...
@Component({
  ...
  providers: [
    { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => TonDatePickerComponent), multi: true },
  ],
  template: `
    <button
      #triggerEl
...
export class TonDatePickerComponent implements ControlValueAccessor, OnDestroy {
