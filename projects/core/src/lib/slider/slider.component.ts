...
@Component({
  ...
  providers: [
    { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => TonSliderComponent), multi: true },
  ],
  template: `
    <div
      #trackEl
...
export class TonSliderComponent implements ControlValueAccessor, OnDestroy {
