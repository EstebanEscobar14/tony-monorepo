...
import { TonSkeletonDirective } from './skeleton.directive';
import type { SkeletonVariant, SkeletonSize } from './skeleton.variants';

@Component({
  standalone: true,
  imports: [TonSkeletonDirective],
  template: `<div tonSkeleton [variant]="variant()" [size]="size()"></div>`,
})
