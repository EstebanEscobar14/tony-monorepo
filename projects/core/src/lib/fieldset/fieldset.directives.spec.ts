...
@Component({
  standalone: true,
  imports: [TonFieldsetDirective, TonFieldsetLegendDirective, TonFieldsetContentDirective],
  template: `
    <fieldset tonFieldset [variant]="variant()" [disabled]="disabled()">
      <legend tonFieldsetLegend>Personal Info</legend>
...
describe('TonFieldsetDirective', () => {
  ...
  it('should apply content classes', () => {
    const content = fixture.nativeElement.querySelector('[tonFieldsetContent]');
