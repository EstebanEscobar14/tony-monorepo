export const HOME_ES = {
  ...
  features: [
    ...
    { icon: '🤖', title: 'AI Ready', description: 'Incluye llms.txt con referencia completa de la API. Las herramientas de IA pueden generar código correcto con componentes de TonyUI.' },
  ],
  showcase: {
  ...
  footer: {
    ...
    subtitle: 'Comienza a construir hermosas apps Angular con TonyUI hoy.',
