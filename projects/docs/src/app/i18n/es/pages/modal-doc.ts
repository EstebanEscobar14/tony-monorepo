export const MODAL_DOC_ES = {
  ...
  tonDialogService: 'TonDialogService',
  tonDialogConfig: 'TonDialogConfig',
  contentDirectives: 'Directivas de contenido',
  contentDirectivesList: [
    '<code class="font-mono text-xs bg-muted px-1 py-0.5 rounded">tonDialogContent</code> — Contenedor principal con estilos',
    '<code class="font-mono text-xs bg-muted px-1 py-0.5 rounded">tonDialogHeader</code> — Sección de encabezado',
    '<code class="font-mono text-xs bg-muted px-1 py-0.5 rounded">tonDialogTitle</code> — Título del diálogo',
    '<code class="font-mono text-xs bg-muted px-1 py-0.5 rounded">tonDialogDescription</code> — Texto de descripción',
    '<code class="font-mono text-xs bg-muted px-1 py-0.5 rounded">tonDialogFooter</code> — Pie de página con acciones',
    '<code class="font-mono text-xs bg-muted px-1 py-0.5 rounded">tonDialogClose</code> — Botón de cerrar',
  ],
  accessibility: [
