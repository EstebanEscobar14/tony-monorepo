export const LIST_DOC_ES = {
  ...
  subDirectives: [
    '<code class="font-mono text-xs bg-muted px-1 py-0.5 rounded">tonListItem</code> — Entrada individual de la lista',
    '<code class="font-mono text-xs bg-muted px-1 py-0.5 rounded">tonListItemContent</code> — Area de contenido principal del elemento',
  ],
  propDescriptions: {
