export const HOME_EN = {
  ...
  features: [
    ...
    { icon: '🤖', title: 'AI Ready', description: 'Includes llms.txt with full API reference. AI tools can generate correct code with TonyUI components.' },
  ],
  showcase: {
  ...
  footer: {
    ...
    subtitle: 'Start building beautiful Angular apps with TonyUI today.',
