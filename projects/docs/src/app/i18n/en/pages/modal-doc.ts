export const MODAL_DOC_EN = {
  ...
  contentDirectivesList: [
    '<code class="font-mono text-xs bg-muted px-1 py-0.5 rounded">tonDialogContent</code> — Main container with styling',
    '<code class="font-mono text-xs bg-muted px-1 py-0.5 rounded">tonDialogHeader</code> — Header section',
    '<code class="font-mono text-xs bg-muted px-1 py-0.5 rounded">tonDialogTitle</code> — Dialog title',
    '<code class="font-mono text-xs bg-muted px-1 py-0.5 rounded">tonDialogDescription</code> — Description text',
    '<code class="font-mono text-xs bg-muted px-1 py-0.5 rounded">tonDialogFooter</code> — Footer with actions',
    '<code class="font-mono text-xs bg-muted px-1 py-0.5 rounded">tonDialogClose</code> — Close button',
  ],
  accessibility: [
