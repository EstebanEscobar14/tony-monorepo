  ...
  sidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Avatar Group', path: '/docs/components/avatar-group' },
        ...
        { label: 'Command Palette', path: '/docs/components/command-palette' },
        ...
        { label: 'Number Input', path: '/docs/components/number-input' },
        ...
        { label: 'Tag Input', path: '/docs/components/tag-input' },
