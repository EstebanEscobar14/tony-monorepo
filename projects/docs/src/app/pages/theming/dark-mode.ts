...
import { TonButtonDirective, ThemeService } from '@tony-ui/core';
...
@Component({
  ...
  standalone: true,
  imports: [CodeBlockComponent, TonButtonDirective],
  template: `
    <div class="space-y-8">
      <div>
      ...
      <section class="space-y-4">
        ...
        <div class="flex gap-4">
          <button tonBtn (click)="themeService.setTheme('light')">Light</button>
          <button tonBtn variant="outline" (click)="themeService.setTheme('dark')">Dark</button>
          <button tonBtn variant="secondary" (click)="themeService.toggleDark()">Toggle</button>
        </div>
...
export class DarkModeComponent {
  ...
  toggleCode = `import { ThemeService } from '@tony-ui/core';
