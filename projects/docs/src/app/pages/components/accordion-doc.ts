    ...
    <div class="space-y-8">
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="basicCode" language="markup">
          <div tonAccordion class="max-w-lg">
            <div tonAccordionItem value="item-1">
              <button tonAccordionTrigger>
                Is it accessible?
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>
              </button>
              <div tonAccordionContent>
            ...
            <div tonAccordionItem value="item-3">
              <button tonAccordionTrigger>
                Is it animated?
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>
              </button>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="exampleCode" language="typescript">
          <div class="space-y-4 max-w-lg">
            ...
            <div tonAccordion [multi]="multiMode()">
              @for (faq of faqs; track faq.q) {
                <div tonAccordionItem [value]="faq.q">
                  <button tonAccordionTrigger>
                    {{ faq.q }}
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>
                  </button>
...
export class AccordionDocComponent {
  ...
  faqs = [
    { q: 'What is TonyUI?', a: 'TonyUI is a collection of beautiful, accessible Angular components built with Tailwind CSS v4 and Signals.' },
    { q: 'Is it free?', a: 'Yes, TonyUI is open source and free to use under the MIT license.' },
    { q: 'Does it support dark mode?', a: 'Yes, TonyUI includes light, dark, and corporate themes out of the box.' },
  ];
  ...
  basicCode = `<div tonAccordion>
  <div tonAccordionItem value="item-1">
    <button tonAccordionTrigger>Is it accessible?</button>
    <div tonAccordionContent>
...
<div tonAccordion [multi]="multiMode()">
  @for (faq of faqs; track faq.q) {
    <div tonAccordionItem [value]="faq.q">
      <button tonAccordionTrigger>{{ faq.q }}</button>
      <div tonAccordionContent>
        <div>{{ faq.a }}</div>
      </div>
    </div>
