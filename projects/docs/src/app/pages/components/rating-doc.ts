...
import { TonRatingComponent } from '@tony-ui/core';
...
@Component({
  ...
  standalone: true,
  imports: [CodeBlockComponent, ComponentPreviewComponent, PropsTableComponent, TonRatingComponent, ReactiveFormsModule],
  template: `
    <div class="space-y-8">
      <div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="sizesCode">
          <div class="space-y-3">
            <ton-rating size="sm" [value]="3" [readonly]="true" />
            <ton-rating size="md" [value]="3" [readonly]="true" />
            <ton-rating size="lg" [value]="3" [readonly]="true" />
          </div>
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="readonlyCode">
          <ton-rating [value]="4" [readonly]="true" />
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="exampleCode" language="typescript">
          <div class="space-y-2">
            <ton-rating [(value)]="heartRating" ratingVariant="heart" />
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="reactiveFormsCode" language="typescript">
          <div class="space-y-2">
            <ton-rating [formControl]="ratingCtrl" />
...
<ton-rating [formControl]="ratingCtrl" />`;
  ...
  importCode = `import { TonRatingComponent } from '@tony-ui/core';`;
  basicCode = `<ton-rating [(value)]="rating" />`;
  sizesCode = `<ton-rating size="sm" [value]="3" [readonly]="true" />
<ton-rating size="md" [value]="3" [readonly]="true" />
<ton-rating size="lg" [value]="3" [readonly]="true" />`;
  readonlyCode = `<ton-rating [value]="4" [readonly]="true" />`;
