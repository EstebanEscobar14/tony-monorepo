...
import { TonAvatarGroupComponent, type AvatarGroupItem } from '@tony-ui/core';
...
@Component({
  ...
  standalone: true,
  imports: [CodeBlockComponent, ComponentPreviewComponent, PropsTableComponent, TonAvatarGroupComponent],
  template: `
    <div class="space-y-8">
      <div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="basicCode" language="markup">
          <ton-avatar-group [items]="users" [max]="3" />
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="fallbackCode" language="markup">
          <ton-avatar-group [items]="initialsUsers" [max]="4" />
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="sizesCode" language="markup">
          <div class="flex items-center gap-6">
            <ton-avatar-group [items]="users" [max]="3" size="sm" />
            <ton-avatar-group [items]="users" [max]="3" size="md" />
            <ton-avatar-group [items]="users" [max]="3" size="lg" />
          </div>
        </docs-component-preview>
      </section>
...
export class AvatarGroupDocComponent {
  ...
  importCode = `import { TonAvatarGroupComponent, type AvatarGroupItem } from '@tony-ui/core';`;
...
<ton-avatar-group [items]="users" [max]="4" />`;

  sizesCode = `<ton-avatar-group [items]="users" size="sm" />
<ton-avatar-group [items]="users" size="md" />
<ton-avatar-group [items]="users" size="lg" />`;
