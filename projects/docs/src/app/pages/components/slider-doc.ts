...
import { TonSliderComponent, TonLabelDirective } from '@tony-ui/core';
...
@Component({
  ...
  standalone: true,
  imports: [CodeBlockComponent, ComponentPreviewComponent, PropsTableComponent, TonSliderComponent, TonLabelDirective, ReactiveFormsModule],
  template: `
    <div class="space-y-8">
      <div>
        ...
        <docs-component-preview [code]="sizesCode">
          <div class="w-full max-w-sm space-y-4">
            <div class="space-y-1">
              ...
              <ton-slider size="sm" [value]="30" />
            </div>
            <div class="space-y-1">
              <label tonLabel>Medium</label>
              <ton-slider size="md" [value]="50" />
            </div>
            <div class="space-y-1">
              <label tonLabel>Large</label>
              <ton-slider size="lg" [value]="70" />
            </div>
          </div>
        </docs-component-preview>
      </section>
        ...
        <docs-component-preview [code]="exampleCode" language="typescript">
          <div class="w-full max-w-sm space-y-2">
            <div class="flex justify-between text-sm">
              <label tonLabel>Volume</label>
              <span class="text-muted-foreground">{{ volume() }}%</span>
            </div>
            <ton-slider [(value)]="volume" [min]="0" [max]="100" [step]="5" />
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="reactiveFormsCode" language="typescript">
          <div class="w-full max-w-sm space-y-2">
            <ton-slider [formControl]="sliderCtrl" />
...
<ton-slider [formControl]="sliderCtrl" />`;
  ...
  importCode = `import { TonSliderComponent } from '@tony-ui/core';`;
  basicCode = `<ton-slider [(value)]="volume" />`;
  sizesCode = `<ton-slider size="sm" [value]="30" />
<ton-slider size="md" [value]="50" />
<ton-slider size="lg" [value]="70" />`;
