...
import { TonComboboxComponent, type ComboboxOption } from '@tony-ui/core';

@Component({
  selector: 'docs-combobox-doc',
  standalone: true,
  imports: [CodeBlockComponent, ComponentPreviewComponent, PropsTableComponent, TonComboboxComponent, ReactiveFormsModule],
  template: `
    <div class="space-y-8">
      <div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="reactiveFormsCode" language="typescript">
          <div class="w-56 space-y-2">
            <ton-combobox [options]="frameworks" [formControl]="comboboxCtrl" placeholder="Select framework..." searchPlaceholder="Search..." />
...
<ton-combobox [options]="frameworks" [formControl]="comboboxCtrl" />`;

  importCode = `import { TonComboboxComponent, type ComboboxOption } from '@tony-ui/core';`;

  basicCode = `<ton-combobox
  [options]="frameworks"
  placeholder="Select framework..."
  searchPlaceholder="Search framework..."
/>`;
