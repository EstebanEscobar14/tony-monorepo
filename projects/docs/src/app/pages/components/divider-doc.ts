...
import { TonDividerComponent } from '@tony-ui/core';
...
@Component({
  ...
  standalone: true,
  imports: [CodeBlockComponent, ComponentPreviewComponent, PropsTableComponent, TonDividerComponent],
  template: `
    <div class="space-y-8">
      <div>
...
export class DividerDocComponent {
  ...
  importCode = `import { TonDividerComponent } from '@tony-ui/core';`;

  basicCode = `<ton-divider />`;

  labelCode = `<ton-divider label="OR" />`;
