    ...
    <div class="space-y-8">
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="basicCode" language="markup">
          <nav tonNavbar>
            <div tonNavbarBrand>MyApp</div>
            <div tonNavbarContent>
              <a href="#">Home</a>
              <a href="#">About</a>
              <a href="#">Contact</a>
            </div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="borderedCode" language="markup">
          <nav tonNavbar variant="bordered">
            <div tonNavbarBrand>MyApp</div>
            <div tonNavbarContent>
              <a href="#">Home</a>
              <a href="#">About</a>
        ...
        <docs-component-preview [code]="floatingCode" language="markup">
          <nav tonNavbar variant="floating" class="w-full">
            <div tonNavbarBrand>MyApp</div>
            <div tonNavbarContent>
              <a href="#">Home</a>
              <a href="#">About</a>
...
export class NavbarDocComponent {
  ...
  borderedCode = `<nav tonNavbar variant="bordered">
  <div tonNavbarBrand>MyApp</div>
  <div tonNavbarContent>
    <a href="#">Home</a>
    <a href="#">About</a>
  ...
  floatingCode = `<nav tonNavbar variant="floating">
  <div tonNavbarBrand>MyApp</div>
  <div tonNavbarContent>
    <a href="#">Home</a>
    <a href="#">About</a>
