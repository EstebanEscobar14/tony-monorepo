...
import { TonKbdDirective } from '@tony-ui/core';
...
@Component({
  ...
  standalone: true,
  imports: [CodeBlockComponent, ComponentPreviewComponent, PropsTableComponent, TonKbdDirective],
  template: `
    <div class="space-y-8">
      <div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="sizesCode">
          <div class="flex items-center gap-4">
            <kbd tonKbd size="sm">Shift</kbd>
            <kbd tonKbd size="md">Shift</kbd>
            <kbd tonKbd size="lg">Shift</kbd>
          </div>
        </docs-component-preview>
      </section>
...
export class KbdDocComponent {
  ...
  importCode = `import { TonKbdDirective } from '@tony-ui/core';`;

  basicCode = `<kbd tonKbd>Ctrl</kbd>
<span>+</span>
<kbd tonKbd>C</kbd>`;

  sizesCode = `<kbd tonKbd size="sm">Shift</kbd>
<kbd tonKbd size="md">Shift</kbd>
<kbd tonKbd size="lg">Shift</kbd>`;
