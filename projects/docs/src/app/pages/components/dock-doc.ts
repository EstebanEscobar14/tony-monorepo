...
import { TonDockDirective, TonDockItemDirective } from '@tony-ui/core';
    ...
    <div class="space-y-8">
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="basicCode">
          <div tonDock class="relative">
            @for (item of dockItems; track item) {
              <button tonDockItem [attr.aria-label]="item">
...
export class DockDocComponent {
  ...
  importCode = `import { TonDockDirective, TonDockItemDirective } from '@tony-ui/core';`;

  basicCode = `<div tonDock>
  <button tonDockItem aria-label="Home">Home</button>
  <button tonDockItem aria-label="Search">Search</button>
  <button tonDockItem aria-label="Mail">Mail</button>
</div>`;
