...
import { TonDatePickerComponent } from '@tony-ui/core';
...
@Component({
  ...
  standalone: true,
  imports: [CodeBlockComponent, ComponentPreviewComponent, PropsTableComponent, TonDatePickerComponent],
  template: `
    <div class="space-y-8">
      <div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="basicCode" language="markup">
          <div class="w-full max-w-sm">
            <ton-date-picker [(value)]="selectedDate" />
          </div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="clearableCode" language="markup">
          <div class="w-full max-w-sm">
            <ton-date-picker [(value)]="clearableDate" [clearable]="true" />
          </div>
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="constraintsCode" language="markup">
          <div class="w-full max-w-sm">
            <ton-date-picker [(value)]="constrainedDate" [min]="minDate" [max]="maxDate" placeholder="Within next 30 days..." />
          </div>
        </docs-component-preview>
      </section>
...
export class DatePickerDocComponent {
  ...
  importCode = `import { TonDatePickerComponent } from '@tony-ui/core';`;

  basicCode = `<ton-date-picker [(value)]="selectedDate" />`;

  clearableCode = `<ton-date-picker [(value)]="date" [clearable]="true" />`;

  constraintsCode = `<ton-date-picker
  [(value)]="date"
  [min]="minDate"
  [max]="maxDate"
