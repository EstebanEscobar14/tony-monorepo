...
import { TonDateRangePickerComponent, type DateRange, type DatePickerPreset } from '@tony-ui/core';
...
@Component({
  ...
  standalone: true,
  imports: [CodeBlockComponent, ComponentPreviewComponent, PropsTableComponent, TonDateRangePickerComponent],
  template: `
    <div class="space-y-8">
      <div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="singleCode" language="markup">
          <div class="w-full max-w-sm">
            <ton-date-range-picker [(value)]="singleRange" />
          </div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="dualCode" language="markup">
          <div class="w-full max-w-md">
            <ton-date-range-picker [(value)]="dualRange" [dualCalendar]="true" />
          </div>
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="presetsCode" language="markup">
          <div class="w-full max-w-md">
            <ton-date-range-picker [(value)]="presetRange" [presets]="presets" />
          </div>
        </docs-component-preview>
      </section>
...
export class DateRangePickerDocComponent {
  ...
  importCode = `import { TonDateRangePickerComponent, type DateRange, type DatePickerPreset } from '@tony-ui/core';`;

  singleCode = `<ton-date-range-picker [(value)]="range" />`;

  dualCode = `<ton-date-range-picker [(value)]="range" [dualCalendar]="true" />`;
...
<ton-date-range-picker [(value)]="range" [presets]="presets" />`;

  fullCode = `<ton-date-range-picker
  [(value)]="range"
  [dualCalendar]="true"
  [presets]="presets"
  [clearable]="true"
