...
import { TonSkeletonDirective } from '@tony-ui/core';
...
@Component({
  ...
  standalone: true,
  imports: [CodeBlockComponent, ComponentPreviewComponent, PropsTableComponent, TonSkeletonDirective],
  template: `
    <div class="space-y-8">
      <div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="basicCode">
          <div class="space-y-2 w-full max-w-sm">
            <div tonSkeleton size="sm" class="w-3/4"></div>
            <div tonSkeleton size="md" class="w-full"></div>
            <div tonSkeleton size="sm" class="w-1/2"></div>
          </div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="variantsCode">
          <div class="flex items-center gap-6">
            <div tonSkeleton variant="line" size="lg" class="w-48"></div>
            <div tonSkeleton variant="circular" size="xl"></div>
            <div tonSkeleton variant="rounded" size="lg" class="w-32"></div>
          </div>
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="exampleCode">
          <div class="flex items-center gap-4 max-w-sm w-full">
            <div tonSkeleton variant="circular" class="h-12 w-12"></div>
...
export class SkeletonDocComponent {
  ...
  importCode = `import { TonSkeletonDirective } from '@tony-ui/core';`;
  basicCode = `<div tonSkeleton size="sm" class="w-3/4"></div>
<div tonSkeleton size="md" class="w-full"></div>
<div tonSkeleton size="sm" class="w-1/2"></div>`;
  variantsCode = `<div tonSkeleton variant="line" size="lg" class="w-48"></div>
<div tonSkeleton variant="circular" size="xl"></div>
<div tonSkeleton variant="rounded" size="lg" class="w-32"></div>`;
