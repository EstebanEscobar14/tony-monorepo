...
import { TonOtpInputComponent, TonButtonDirective } from '@tony-ui/core';
...
@Component({
  ...
  imports: [
    ...
    TonOtpInputComponent, TonButtonDirective,
  ],
  template: `
    <div class="space-y-8">
      <div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="basicCode" language="markup">
          <div class="space-y-2 text-center">
            <ton-otp-input [(value)]="basicOtp" [autoFocus]="false" />
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="fourCode" language="markup">
          <ton-otp-input [(value)]="fourOtp" [length]="4" [autoFocus]="false" />
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="alphaCode" language="markup">
          <ton-otp-input [(value)]="alphaOtp" type="alphanumeric" [autoFocus]="false" />
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="maskCode" language="markup">
          <ton-otp-input [(value)]="maskOtp" [mask]="true" [length]="4" [autoFocus]="false" />
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="sepCode" language="markup">
          <ton-otp-input [(value)]="sepOtp" [separator]="3" [autoFocus]="false" />
        </docs-component-preview>
      </section>
        ...
        <docs-component-preview [code]="fullCode" language="typescript">
          <div class="space-y-3 text-center">
            ...
            <div class="flex justify-center gap-2">
              <button tonBtn size="sm" [disabled]="fullOtp().length < 6 || otpStatus() === 'loading'" (click)="verify()">Verify</button>
              <button tonBtn variant="outline" size="sm" (click)="reset()">Reset</button>
            </div>
          </div>
        </docs-component-preview>
      </section>
...
export class OtpInputDocComponent {
  ...
  importCode = `import { TonOtpInputComponent } from '@tony-ui/core';`;
  basicCode = `<ton-otp-input [(value)]="otp" />`;
  fourCode = `<ton-otp-input [(value)]="otp" [length]="4" />`;
  alphaCode = `<ton-otp-input [(value)]="otp" type="alphanumeric" />`;
  maskCode = `<ton-otp-input [(value)]="otp" [mask]="true" [length]="4" />`;
  sepCode = `<ton-otp-input [(value)]="otp" [separator]="3" />`;
...
@Component({
  ...
  standalone: true,
  imports: [TonOtpInputComponent, TonButtonDirective],
  template: \\\`
    ...
    <ton-otp-input
      ...
      (completed)="onCompleted($event)"
    />
    <button tonBtn (click)="verify()">Verify</button>
    <button tonBtn variant="outline" (click)="reset()">Reset</button>
  \\\`,
})
