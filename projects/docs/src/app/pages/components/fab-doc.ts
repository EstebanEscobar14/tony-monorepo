...
import { TonFabDirective, TonFabTriggerDirective, TonFabActionDirective } from '@tony-ui/core';
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="basicCode">
          <div class="relative h-48 w-full border rounded-lg">
            <div tonFab position="bottom-right">
              <button tonFabTrigger>+</button>
              <button tonFabAction label="Edit">E</button>
              <button tonFabAction label="Share">S</button>
              <button tonFabAction label="Delete">D</button>
            </div>
          </div>
...
export class FabDocComponent {
  ...
  basicCode = `<div tonFab position="bottom-right">
  <button tonFabTrigger>+</button>
  <button tonFabAction label="Edit">E</button>
  <button tonFabAction label="Share">S</button>
  <button tonFabAction label="Delete">D</button>
