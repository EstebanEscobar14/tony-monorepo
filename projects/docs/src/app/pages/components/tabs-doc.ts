...
import {
  TonTabsDirective,
  TonTabsListDirective,
  TonTabsTriggerDirective,
  TonTabsContentDirective,
  TonInputDirective,
  TonLabelDirective,
  TonButtonDirective,
} from '@tony-ui/core';
...
@Component({
  ...
  imports: [
    ...
    TonTabsDirective, TonTabsListDirective, TonTabsTriggerDirective, TonTabsContentDirective,
    TonInputDirective, TonLabelDirective, TonButtonDirective,
  ],
  template: `
    <div class="space-y-8">
      <div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="basicCode" language="markup">
          <div tonTabs [(value)]="activeTab" class="w-full max-w-md">
            <div tonTabsList>
              <button tonTabsTrigger value="account">Account</button>
              <button tonTabsTrigger value="password">Password</button>
              <button tonTabsTrigger value="notifications">Notifications</button>
            </div>
            <div tonTabsContent value="account" class="space-y-4">
              <div class="space-y-2">
                <label tonLabel>Name</label>
                <input tonInput placeholder="Your name" />
              </div>
              <div class="space-y-2">
                <label tonLabel>Email</label>
                <input tonInput type="email" placeholder="you&#64;example.com" />
              </div>
              <button tonBtn>Save changes</button>
            </div>
            <div tonTabsContent value="password" class="space-y-4">
              <div class="space-y-2">
                <label tonLabel>Current password</label>
                <input tonInput type="password" />
              </div>
              <div class="space-y-2">
                <label tonLabel>New password</label>
                <input tonInput type="password" />
              </div>
              <button tonBtn>Update password</button>
            </div>
            <div tonTabsContent value="notifications" class="space-y-2">
              <p class="text-sm text-muted-foreground">Manage your notification preferences.</p>
              <button tonBtn variant="outline">Configure</button>
            </div>
          </div>
