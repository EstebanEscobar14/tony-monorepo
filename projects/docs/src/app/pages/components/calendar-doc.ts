...
import { TonCalendarComponent } from '@tony-ui/core';
...
@Component({
  ...
  standalone: true,
  imports: [CodeBlockComponent, ComponentPreviewComponent, PropsTableComponent, TonCalendarComponent, ReactiveFormsModule],
  template: `
    <div class="space-y-8">
      <div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="interactiveCode" language="typescript">
          <div class="space-y-2">
            <ton-calendar [(value)]="selectedDate" />
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="reactiveFormsCode" language="typescript">
          <div class="space-y-2">
            <ton-calendar [formControl]="calendarCtrl" />
...
<ton-calendar [formControl]="calendarCtrl" />`;
  ...
  importCode = `import { TonCalendarComponent } from '@tony-ui/core';`;
  basicCode = `<ton-calendar />`;
