...
import { TonFileInputComponent } from '@tony-ui/core';
...
@Component({
  ...
  standalone: true,
  imports: [CodeBlockComponent, ComponentPreviewComponent, PropsTableComponent, TonFileInputComponent, ReactiveFormsModule],
  template: `
    <div class="space-y-8">
      <div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="basicCode">
          <div class="w-full max-w-sm">
            <ton-file-input placeholder="Choose file..." />
          </div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="variantsCode">
          <div class="space-y-3 w-full max-w-sm">
            <ton-file-input placeholder="Default" />
            <ton-file-input variant="error" placeholder="Error state" />
          </div>
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="sizesCode">
          <div class="space-y-3 w-full max-w-sm">
            <ton-file-input size="sm" placeholder="Small" />
            <ton-file-input size="md" placeholder="Medium" />
            <ton-file-input size="lg" placeholder="Large" />
          </div>
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="disabledCode">
          <div class="w-full max-w-sm">
            <ton-file-input [disabled]="true" placeholder="Disabled" />
          </div>
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="exampleCode" language="typescript">
          <div class="w-full max-w-sm">
            <ton-file-input accept="image/*" [multiple]="true" placeholder="Drop images here or click to browse..." />
          </div>
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="reactiveFormsCode" language="typescript">
          <div class="w-full max-w-sm">
            <ton-file-input [formControl]="fileCtrl" placeholder="Choose file..." />
          </div>
        </docs-component-preview>
      </section>
...
<ton-file-input [formControl]="fileCtrl" />`;

  importCode = `import { TonFileInputComponent } from '@tony-ui/core';`;
  basicCode = `<ton-file-input placeholder="Choose file..." />`;
  variantsCode = `<ton-file-input placeholder="Default" />
<ton-file-input variant="error" placeholder="Error state" />`;
  sizesCode = `<ton-file-input size="sm" placeholder="Small" />
<ton-file-input size="md" placeholder="Medium" />
<ton-file-input size="lg" placeholder="Large" />`;
  disabledCode = `<ton-file-input [disabled]="true" placeholder="Disabled" />`;
  exampleCode = `<ton-file-input
  accept="image/*"
  [multiple]="true"
