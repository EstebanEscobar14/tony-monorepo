...
import { TonProgressComponent, type ProgressVariant } from '@tony-ui/core';
...
@Component({
  ...
  standalone: true,
  imports: [CodeBlockComponent, ComponentPreviewComponent, PropsTableComponent, TonProgressComponent],
  template: `
    <div class="space-y-8">
      <div>
        ...
        <docs-component-preview [code]="variantsCode">
          <div class="space-y-4 w-full">
            @for (v of variants; track v) {
              <ton-progress [value]="65" [variant]="v" [label]="v" />
            }
          </div>
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="sizesCode">
          <div class="space-y-4 w-full">
            <ton-progress [value]="50" size="sm" label="Small" />
            <ton-progress [value]="50" size="md" label="Medium" />
            <ton-progress [value]="50" size="lg" label="Large" />
          </div>
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="indeterminateCode">
          <ton-progress [indeterminate]="true" label="Loading..." />
        </docs-component-preview>

        <h3 class="text-lg font-medium">{{ t().interactiveExample }}</h3>
        <docs-component-preview [code]="interactiveCode">
          <div class="space-y-4 w-full">
            <ton-progress [value]="progressValue()" variant="success" label="Upload progress" />
...
export class ProgressDocComponent {
  ...
  importCode = `import { TonProgressComponent } from '@tony-ui/core';`;
  basicCode = `<ton-progress [value]="60" />`;
  variantsCode = `<ton-progress [value]="65" variant="success" />
<ton-progress [value]="65" variant="warning" />
<ton-progress [value]="65" variant="error" />`;
  sizesCode = `<ton-progress [value]="50" size="sm" />
<ton-progress [value]="50" size="md" />
<ton-progress [value]="50" size="lg" />`;
  indeterminateCode = `<ton-progress [indeterminate]="true" label="Loading..." />`;
  interactiveCode = `readonly progressValue = signal(40);

<ton-progress [value]="progressValue()" variant="success" />`;
