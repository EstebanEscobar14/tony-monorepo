...
import { TonTagInputComponent } from '@tony-ui/core';
...
@Component({
  ...
  standalone: true,
  imports: [CodeBlockComponent, ComponentPreviewComponent, PropsTableComponent, TonTagInputComponent],
  template: `
    <div class="space-y-8">
      <div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="maxCode" language="markup">
          <div class="w-full max-w-md">
            <ton-tag-input [(value)]="maxTags" [maxTags]="3" placeholder="Max 3 tags..." />
          </div>
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="validateCode" language="markup">
          <div class="w-full max-w-md space-y-2">
            <ton-tag-input [(value)]="validatedTags" [validate]="minLengthValidator" placeholder="Min 3 characters..." />
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="prefilledCode" language="markup">
          <div class="w-full max-w-md">
            <ton-tag-input [(value)]="prefilledTags" />
          </div>
        </docs-component-preview>
      </section>
...
export class TagInputDocComponent {
  ...
  importCode = `import { TonTagInputComponent } from '@tony-ui/core';`;
  basicCode = `<ton-tag-input [(value)]="tags" />`;
  maxCode = `<ton-tag-input [(value)]="tags" [maxTags]="3" />`;
  validateCode = `validator = (tag: string) => tag.length >= 3;

<ton-tag-input [(value)]="tags" [validate]="validator" />`;
  prefilledCode = `tags = signal(['Angular', 'Tailwind', 'Signals']);

<ton-tag-input [(value)]="tags" />`;
