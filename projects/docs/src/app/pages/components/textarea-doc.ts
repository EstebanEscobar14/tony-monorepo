...
import { TonTextareaDirective } from '@tony-ui/core';
...
@Component({
  ...
  standalone: true,
  imports: [CodeBlockComponent, ComponentPreviewComponent, PropsTableComponent, TonTextareaDirective],
  template: `
    <div class="space-y-8">
      <div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="basicCode">
          <textarea tonTextarea placeholder="Type your message here."></textarea>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="variantsCode">
          <div class="space-y-4 w-full">
            <textarea tonTextarea placeholder="Default textarea"></textarea>
            <textarea tonTextarea variant="error" placeholder="Error textarea"></textarea>
          </div>
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="sizesCode">
          <div class="space-y-4 w-full">
            <textarea tonTextarea textareaSize="sm" placeholder="Small"></textarea>
            <textarea tonTextarea textareaSize="md" placeholder="Medium"></textarea>
            <textarea tonTextarea textareaSize="lg" placeholder="Large"></textarea>
          </div>
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="autoResizeCode">
          <textarea tonTextarea [autoResize]="true" placeholder="Type here — I will grow!"></textarea>
        </docs-component-preview>
      </section>
...
export class TextareaDocComponent {
  ...
  importCode = `import { TonTextareaDirective } from '@tony-ui/core';`;

  basicCode = `<textarea tonTextarea placeholder="Type your message here."></textarea>`;

  variantsCode = `<textarea tonTextarea placeholder="Default textarea"></textarea>
<textarea tonTextarea variant="error" placeholder="Error textarea"></textarea>`;

  sizesCode = `<textarea tonTextarea textareaSize="sm" placeholder="Small"></textarea>
<textarea tonTextarea textareaSize="md" placeholder="Medium"></textarea>
<textarea tonTextarea textareaSize="lg" placeholder="Large"></textarea>`;

  autoResizeCode = `<textarea tonTextarea [autoResize]="true" placeholder="Type here — I will grow!"></textarea>`;
