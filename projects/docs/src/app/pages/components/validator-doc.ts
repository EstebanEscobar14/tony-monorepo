...
import { TonValidatorDirective, TonValidatorHintDirective } from '@tony-ui/core';
    ...
    <div class="space-y-8">
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="basicCode">
          <div tonValidator state="error" class="max-w-sm">
            <span tonValidatorHint type="error">This field is required.</span>
          </div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="exampleCode">
          <div class="space-y-4 max-w-sm">
            <div tonValidator state="error">
              <span tonValidatorHint type="error">Please enter a valid email address.</span>
            </div>
            <div tonValidator state="success">
              <span tonValidatorHint type="success">Email is available!</span>
            </div>
            <div tonValidator state="warning">
              <span tonValidatorHint type="warning">Password strength is weak.</span>
            </div>
          </div>
        </docs-component-preview>
      </section>
...
export class ValidatorDocComponent {
  ...
  basicCode = `<div tonValidator state="error">
  <span tonValidatorHint type="error">This field is required.</span>
</div>`;

  exampleCode = `<div tonValidator state="error">
  <span tonValidatorHint type="error">Please enter a valid email address.</span>
</div>
