...
import { TonColorPickerComponent, type ColorPickerPreset } from '@tony-ui/core';
...
@Component({
  ...
  standalone: true,
  imports: [CodeBlockComponent, ComponentPreviewComponent, PropsTableComponent, TonColorPickerComponent],
  template: `
    <div class="space-y-8">
      <div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="basicCode" language="markup">
          <ton-color-picker [(value)]="basicColor" />
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="inlineCode" language="markup">
          <ton-color-picker [(value)]="inlineColor" [inline]="true" />
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="formatCode" language="markup">
          <ton-color-picker [(value)]="formatColor" format="rgb" [inline]="true" />
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="presetsCode" language="markup">
          <ton-color-picker [(value)]="presetColor" [presets]="presets" [inline]="true" />
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="favoritesCode" language="markup">
          <ton-color-picker [(value)]="favColor" [showFavorites]="true" [inline]="true" />
        </docs-component-preview>
      </section>
...
export class ColorPickerDocComponent {
  ...
  importCode = `import { TonColorPickerComponent, type ColorPickerPreset } from '@tony-ui/core';`;
  basicCode = `<ton-color-picker [(value)]="color" />`;
  inlineCode = `<ton-color-picker [(value)]="color" [inline]="true" />`;
  formatCode = `<ton-color-picker [(value)]="color" format="rgb" />`;
  presetsCode = `presets: ColorPickerPreset[] = [
  { label: 'Tailwind', colors: ['#ef4444', '#f97316', '#22c55e', '#3b82f6'] },
];

<ton-color-picker [(value)]="color" [presets]="presets" />`;

  favoritesCode = `<ton-color-picker [(value)]="color" [showFavorites]="true" />`;
...
@Component({
  ...
  standalone: true,
  imports: [TonColorPickerComponent],
  template: \\\`
    <ton-color-picker
      [(value)]="color"
      [showFavorites]="true"
