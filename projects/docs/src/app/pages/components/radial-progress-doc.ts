...
import { TonRadialProgressComponent } from '@tony-ui/core';
...
@Component({
  ...
  standalone: true,
  imports: [CodeBlockComponent, ComponentPreviewComponent, PropsTableComponent, TonRadialProgressComponent],
  template: `
    <div class="space-y-8">
      <div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="sizesCode">
          <div class="flex items-center gap-6">
            <ton-radial-progress [value]="60" size="sm" />
            <ton-radial-progress [value]="60" size="md" />
            <ton-radial-progress [value]="60" size="lg" />
          </div>
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="interactiveCode" language="typescript">
          <div class="flex flex-col items-center gap-4">
            <ton-radial-progress [value]="progressValue()" size="lg">{{ progressValue() }}%</ton-radial-progress>
...
export class RadialProgressDocComponent {
  ...
  importCode = `import { TonRadialProgressComponent } from '@tony-ui/core';`;
  basicCode = `<ton-radial-progress [value]="70" />`;
  sizesCode = `<ton-radial-progress [value]="60" size="sm" />
<ton-radial-progress [value]="60" size="md" />
<ton-radial-progress [value]="60" size="lg" />`;
  interactiveCode = `readonly progressValue = signal(60);

<ton-radial-progress [value]="progressValue()" size="lg">
  {{ progressValue() }}%
</ton-radial-progress>`;
