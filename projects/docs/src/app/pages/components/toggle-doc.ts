...
import { TonToggleDirective } from '@tony-ui/core';
...
@Component({
  ...
  standalone: true,
  imports: [CodeBlockComponent, ComponentPreviewComponent, PropsTableComponent, TonToggleDirective, ReactiveFormsModule],
  template: `
    <div class="space-y-8">
      <div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="variantsCode">
          <div class="flex items-center gap-2">
            <button tonToggle variant="default">Default</button>
            <button tonToggle variant="outline">Outline</button>
          </div>
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="exampleCode" language="typescript">
          <div class="flex items-center gap-1">
            <button tonToggle [(pressed)]="bold" size="sm">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 12a4 4 0 0 0 0-8H6v8"/><path d="M15 20a4 4 0 0 0 0-8H6v8"/></svg>
            </button>
            <button tonToggle [(pressed)]="italic" size="sm">
            ...
            <button tonToggle [(pressed)]="underline" size="sm">
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="reactiveFormsCode" language="typescript">
          <div class="flex items-center gap-3">
            <button tonToggle [formControl]="toggleCtrl">B</button>
...
<button tonToggle [formControl]="toggleCtrl">B</button>`;
  ...
  importCode = `import { TonToggleDirective } from '@tony-ui/core';`;
  basicCode = `<button tonToggle [(pressed)]="bold">B</button>`;
  variantsCode = `<button tonToggle variant="default">Default</button>
<button tonToggle variant="outline">Outline</button>`;
  exampleCode = `readonly bold = signal(false);
readonly italic = signal(false);

<button tonToggle [(pressed)]="bold" size="sm">B</button>
<button tonToggle [(pressed)]="italic" size="sm">I</button>`;
