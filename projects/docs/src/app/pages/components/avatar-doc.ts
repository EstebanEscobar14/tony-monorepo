...
import { TonAvatarComponent } from '@tony-ui/core';
...
@Component({
  ...
  standalone: true,
  imports: [CodeBlockComponent, ComponentPreviewComponent, PropsTableComponent, TonAvatarComponent],
  template: `
    <div class="space-y-8">
      <div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="basicCode">
          <div class="flex items-center gap-4">
            <ton-avatar alt="John Doe" fallback="JD" />
            <ton-avatar src="https://i.pravatar.cc/150?u=jane" alt="Jane Smith" />
          </div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="sizesCode">
          <div class="flex items-center gap-4">
            <ton-avatar size="sm" alt="SM" fallback="SM" />
            <ton-avatar size="md" alt="MD" fallback="MD" />
            <ton-avatar size="lg" alt="LG" fallback="LG" />
            <ton-avatar size="xl" alt="XL" fallback="XL" />
          </div>
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="variantsCode">
          <div class="flex items-center gap-4">
            <ton-avatar variant="circle" alt="Circle" fallback="C" />
            <ton-avatar variant="rounded" alt="Rounded" fallback="R" />
          </div>
        </docs-component-preview>
      </section>
...
export class AvatarDocComponent {
  ...
  importCode = `import { TonAvatarComponent } from '@tony-ui/core';`;
  basicCode = `<ton-avatar alt="John Doe" fallback="JD" />
<ton-avatar src="https://example.com/avatar.jpg" alt="Jane" />`;
  sizesCode = `<ton-avatar size="sm" fallback="SM" />
<ton-avatar size="md" fallback="MD" />
<ton-avatar size="lg" fallback="LG" />
<ton-avatar size="xl" fallback="XL" />`;
  variantsCode = `<ton-avatar variant="circle" fallback="C" />
<ton-avatar variant="rounded" fallback="R" />`;
