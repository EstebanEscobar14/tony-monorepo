...
import { TonNumberInputComponent } from '@tony-ui/core';
...
@Component({
  ...
  standalone: true,
  imports: [CodeBlockComponent, ComponentPreviewComponent, PropsTableComponent, TonNumberInputComponent],
  template: `
    <div class="space-y-8">
      <div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="basicCode" language="markup">
          <div class="space-y-2 text-center">
            <ton-number-input [(value)]="basicNum" />
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="constraintsCode" language="markup">
          <div class="space-y-2 text-center">
            <ton-number-input [(value)]="constrained" [min]="0" [max]="100" [step]="5" />
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="sizesCode" language="markup">
          <div class="flex items-end gap-4">
            <ton-number-input [(value)]="smNum" size="sm" />
            <ton-number-input [(value)]="mdNum" size="md" />
            <ton-number-input [(value)]="lgNum" size="lg" />
          </div>
        </docs-component-preview>
      </section>
...
export class NumberInputDocComponent {
  ...
  importCode = `import { TonNumberInputComponent } from '@tony-ui/core';`;
  basicCode = `<ton-number-input [(value)]="count" />`;
  constraintsCode = `<ton-number-input [(value)]="count" [min]="0" [max]="100" [step]="5" />`;
  sizesCode = `<ton-number-input size="sm" />
<ton-number-input size="md" />
<ton-number-input size="lg" />`;
