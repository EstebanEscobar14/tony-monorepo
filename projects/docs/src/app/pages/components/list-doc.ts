    ...
    <div class="space-y-8">
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="basicCode" language="markup">
          <div tonList class="max-w-sm w-full">
            <div tonListItem>
              <div tonListItemContent>First item</div>
            </div>
            <div tonListItem>
              <div tonListItemContent>Second item</div>
            </div>
            <div tonListItem>
              <div tonListItemContent>Third item</div>
            </div>
          </div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="variantsCode" language="markup">
          <div class="flex gap-8">
            <div tonList variant="bordered" class="max-w-xs w-full">
              <div tonListItem>
                <div tonListItemContent>Bordered item 1</div>
              </div>
              <div tonListItem>
                <div tonListItemContent>Bordered item 2</div>
              </div>
              <div tonListItem>
                <div tonListItemContent>Bordered item 3</div>
              </div>
            </div>
            <div tonList variant="hover" class="max-w-xs w-full">
              <div tonListItem>
                <div tonListItemContent>Hover item 1</div>
              </div>
              <div tonListItem>
                <div tonListItemContent>Hover item 2</div>
              </div>
              <div tonListItem>
                <div tonListItemContent>Hover item 3</div>
              </div>
            </div>
          </div>
        </docs-component-preview>
      ...
      <section class="space-y-4">
        ...
        <h3 class="text-lg font-medium">TonListDirective</h3>
        <docs-props-table [props]="listProps()" />
        <h3 class="text-lg font-medium mt-4">TonListItemDirective</h3>
...
export class ListDocComponent {
  ...
  variantsCode = `<div tonList variant="bordered">
  <div tonListItem>
    <div tonListItemContent>Bordered item</div>
  </div>
</div>

<div tonList variant="hover">
  <div tonListItem>
    <div tonListItemContent>Hover item</div>
  </div>
</div>`;
