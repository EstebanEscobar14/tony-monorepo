    ...
    <div class="space-y-8">
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="variantsCode" language="markup">
          <div class="flex items-center gap-8">
            <div tonIndicator>
              <span tonIndicatorBadge variant="primary" position="top-start">1</span>
              <div class="w-12 h-12 bg-muted rounded-md"></div>
            </div>
            <div tonIndicator>
              <span tonIndicatorBadge variant="success" position="top-end">2</span>
              <div class="w-12 h-12 bg-muted rounded-md"></div>
            </div>
            <div tonIndicator>
              <span tonIndicatorBadge variant="warning" position="bottom-start">3</span>
              <div class="w-12 h-12 bg-muted rounded-md"></div>
            </div>
            <div tonIndicator>
              <span tonIndicatorBadge variant="error" position="bottom-end">4</span>
              <div class="w-12 h-12 bg-muted rounded-md"></div>
            </div>
          </div>
        </docs-component-preview>
      ...
      <section class="space-y-4">
        ...
        <h3 class="text-lg font-medium">TonIndicatorDirective</h3>
        <docs-props-table [props]="indicatorProps()" />
        <h3 class="text-lg font-medium mt-4">TonIndicatorBadgeDirective</h3>
...
export class IndicatorDocComponent {
  ...
  basicCode = `<div tonIndicator>
  <span tonIndicatorBadge>3</span>
  <div class="w-12 h-12 bg-muted rounded-md">Box</div>
</div>`;

  variantsCode = `<div tonIndicator>
  <span tonIndicatorBadge variant="primary" position="top-start">1</span>
  <div>...</div>
</div>
<div tonIndicator>
