...
import { TonPaginationComponent } from '@tony-ui/core';
...
@Component({
  ...
  standalone: true,
  imports: [CodeBlockComponent, ComponentPreviewComponent, PropsTableComponent, TonPaginationComponent],
  template: `
    <div class="space-y-8">
      <div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="basicCode">
          <ton-pagination [(currentPage)]="currentPage" [totalPages]="10" />
...
export class PaginationDocComponent {
  ...
  importCode = `import { TonPaginationComponent } from '@tony-ui/core';`;
