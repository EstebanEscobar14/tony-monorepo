...
import { TonSelectComponent, TonLabelDirective } from '@tony-ui/core';
...
@Component({
  ...
  standalone: true,
  imports: [CodeBlockComponent, ComponentPreviewComponent, PropsTableComponent, TonSelectComponent, TonLabelDirective, ReactiveFormsModule],
  template: `
    <div class="space-y-8">
      <div>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="basicCode">
          <div class="w-full max-w-xs space-y-2">
            <label tonLabel>Timezone</label>
            <ton-select [options]="timezones" [(value)]="selectedTimezone" placeholder="Select timezone..." />
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="exampleCode" language="typescript">
          <div class="w-full max-w-xs space-y-4">
            <div class="space-y-2">
              <label tonLabel>Language</label>
              <ton-select [options]="languages" [(value)]="selectedLanguage" placeholder="Select language..." />
            </div>
            <div class="space-y-2">
              <label tonLabel>Theme</label>
              <ton-select [options]="themes" [(value)]="selectedTheme" placeholder="Select theme..." />
            </div>
          </div>
        </docs-component-preview>
      </section>
      ...
      <section class="space-y-4">
        ...
        <docs-component-preview [code]="reactiveFormsCode" language="typescript">
          <div class="w-full max-w-xs space-y-2">
            <label tonLabel>Theme</label>
            <ton-select [options]="themes" [formControl]="selectCtrl" placeholder="Select theme..." />
...
<ton-select [options]="themes" [formControl]="selectCtrl" />`;

  importCode = `import { TonSelectComponent } from '@tony-ui/core';`;
  basicCode = `<ton-select
  [options]="timezones"
...
<ton-select [options]="languages" [(value)]="selectedLanguage" />`;
