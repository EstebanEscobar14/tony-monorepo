...
export class InstallationComponent {
  ...
  ngAddCode = `ng add @tony-ui/core@latest`;
  installCode = `npm install @tony-ui/core@latest`;
  cssImportCode = `@import "tailwindcss";
@import "@tony-ui/core/styles/sonny-theme.css";`;
  tailwindSourceCode = `@source "../node_modules/@tony-ui/core";`;
  providerCode = `import { provideTonyUI } from '@tony-ui/core';
